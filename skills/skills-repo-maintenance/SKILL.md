...
description: Maintain the canonical global skills repository, verify that ~/.agents/skills is the only runtime source, generate its one-way Obsidian mirror, audit skill metadata and tool dependencies, and explicitly promote reviewed mirror edits. Use for global skill installation, migration, deduplication, mirroring, promotion, or drift repair.
---
...
recreate `~/.codex/skills`. Stage third-party skills outside the canonical tree,
read them completely, retain their license/provenance, remove irrelevant or
