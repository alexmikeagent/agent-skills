...
```
export AGENTS_SKILLS_DIR="${AGENTS_SKILLS_DIR:-$HOME/.agents/skills}"
export IMAGE_GEN="$AGENTS_SKILLS_DIR/imagegen/scripts/image_gen.py"
```
...
- Built-in-first transparent image workflow: `SKILL.md` and `~/.agents/skills/imagegen/scripts/remove_chroma_key.py`
